document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            ...
            btn.innerHTML = '<i data-lucide="check-circle" style="width:18px;height:18px;margin-right:8px;vertical-align:middle;"></i> Gesendet!';
    ...
    if (gsForm) {
        gsForm.addEventListener('submit', (e) => {
            ...
            btn.innerHTML = '<i data-lucide="check-circle" style="width:18px;height:18px;"></i> Gesendet!';
            btn.style.background = 'var(--success)';
            btn.style.boxShadow = '0 4px 15px rgba(16, 185, 129, 0.4)';
            lucide.createIcons();
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            formData.append("subject", "New Contact Request: " + name);
            ...
            .then(async (response) => {
                if (response.status === 200) {
                    btn.innerHTML = '<i data-lucide="check-circle" style="width:18px;height:18px;margin-right:8px;vertical-align:middle;"></i> Sent Successfully!';
                    btn.style.background = 'var(--success)';
                    btn.style.boxShadow = '0 4px 15px rgba(16, 185, 129, 0.4)';
                    lucide.createIcons();
                    contactForm.reset();
